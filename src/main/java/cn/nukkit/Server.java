...
public class Server
{
	...
	)
	{
		...
		this.consoleThread = new NukkitConsoleThread(this.getConsole());
		...
		Nukkit.DEBUG = Math.clamp((int)this.getConfig("debug.level", 1), 1, 3);
	...
	public NukkitConsoleThread getConsoleThread()
	{
	...
	public void sendFullPlayerListData(
		Player player,
		boolean self
	)
	{
	...
	public static class NukkitConsoleThread extends Thread implements InterruptibleThread
	{
