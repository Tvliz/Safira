 ...
 * 和 {@link cn.nukkit.plugin.PluginLoadOrder#POSTWORLD}。<br> The load order of a Nukkit plugin can be {@link cn.nukkit.plugin.PluginLoadOrder#STARTUP} or {@link cn.nukkit.plugin.PluginLoadOrder#POSTWORLD}.</p>
 *
