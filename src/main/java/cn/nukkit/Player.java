    ...
    public void handleDataPacket(DataPacket packet) {
        ...
        switch (packet.pid()) {
            ...
            case ProtocolInfo.CRAFTING_EVENT_PACKET:
                ...
                if (this.craftingType == CRAFTING_ANVIL) {
                    ...
                    if (anvilInventory == null) {
                        ...
                        if (anvilInventory == null) { // If it'sf _still_ null, then the player doesn't have a valid
            ...
            case ProtocolInfo.CONTAINER_SET_SLOT_PACKET:
                ...
                } else if (containerSetSlotPacket.windowid == ContainerSetContentPacket.SPECIAL_ARMOR) { // Our
                    // armor
