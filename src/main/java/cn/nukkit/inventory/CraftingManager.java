...
public class CraftingManager {
    ...
    public CraftingManager() {
        ...
        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.GLOWSTONE_BLOCK, 0, 1),
                "XX",
                "XX"
        )).setIngredient("X", Item.get(Item.GLOWSTONE_DUST, 0, 1)));
        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.LIT_PUMPKIN, 0, 1),
                "X ",
                "Y "
        ...
        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.WOODEN_PLANK, BlockPlanks.OAK, 4),
                "X"
        )).setIngredient("X", Item.get(Item.WOOD, BlockWood.OAK, 1)));

        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.WOODEN_PLANK, BlockPlanks.SPRUCE, 4),
                "X"
        )).setIngredient("X", Item.get(Item.WOOD, BlockWood.SPRUCE, 1)));

        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.WOODEN_PLANK, BlockPlanks.BIRCH, 4),
                "X"
        )).setIngredient("X", Item.get(Item.WOOD, BlockWood.BIRCH, 1)));

        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.WOODEN_PLANK, BlockPlanks.JUNGLE, 4),
                "X"
        )).setIngredient("X", Item.get(Item.WOOD, BlockWood.JUNGLE, 1)));

        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.WOODEN_PLANK, BlockPlanks.ACACIA, 4),
                "X"
        )).setIngredient("X", Item.get(Item.WOOD2, BlockWood2.ACACIA, 1)));

        this.registerRecipe((new ShapedRecipe(
                Item.get(Item.WOODEN_PLANK, BlockPlanks.DARK_OAK, 4),
                "X"
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.ENCHANTMENT_TABLE, 0, 1),
                " B ",
                "DOD",
                "OOO"
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.FENCE, BlockPlanks.OAK, 3),
                "PSP",
                "PSP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.FENCE, BlockPlanks.SPRUCE, 3),
                "PSP",
                "PSP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.FENCE, BlockPlanks.BIRCH, 3),
                "PSP",
                "PSP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.FENCE, BlockPlanks.JUNGLE, 3),
                "PSP",
                "PSP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.FENCE, BlockPlanks.ACACIA, 3),
                "PSP",
                "PSP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.FENCE, BlockPlanks.DARK_OAK, 3),
                "PSP",
                "PSP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.NETHER_BRICK_FENCE, 0, 3),
                "PPP",
                "PPP",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.COBBLESTONE_WALL, BlockWall.NONE_MOSSY_WALL, 6),
                "CCC",
                "CCC",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.COBBLESTONE_WALL, BlockWall.MOSSY_WALL, 6),
                "MMM",
                "MMM",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.BRICK_STAIRS, 0, 4),
                "P  ",
                "PP ",
                "PPP"
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE_BRICK_STAIRS, 0, 4),
                "P  ",
                "PP ",
                "PPP"
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.QUARTZ_STAIRS, 0, 4),
                "P  ",
                "PP ",
                "PPP"
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.NETHER_BRICKS_STAIRS, 0, 4),
                "P  ",
                "PP ",
                "PPP"
        )).setIngredient("P", Item.get(Item.NETHER_BRICK_BLOCK, 0, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.STONE, 6),
                "PPP",
                "   ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.SANDSTONE, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.SANDSTONE, null, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.WOOD_SLAB, BlockPlanks.OAK, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.WOODEN_PLANK, BlockPlanks.OAK, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.WOOD_SLAB, BlockPlanks.SPRUCE, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.WOODEN_PLANK, BlockPlanks.SPRUCE, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.WOOD_SLAB, BlockPlanks.BIRCH, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.WOODEN_PLANK, BlockPlanks.BIRCH, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.WOOD_SLAB, BlockPlanks.JUNGLE, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.WOODEN_PLANK, BlockPlanks.JUNGLE, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.WOOD_SLAB, BlockPlanks.ACACIA, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.WOODEN_PLANK, BlockPlanks.ACACIA, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.WOOD_SLAB, BlockPlanks.DARK_OAK, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.WOODEN_PLANK, BlockPlanks.DARK_OAK, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.COBBLESTONE, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.COBBLESTONE, 0, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.BRICK, 6),
                "PPP",
                "   ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.STONE_BRICK, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.STONE_BRICK, 0, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.QUARTZ, 6),
                "PPP",
                "   ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SLAB, BlockSlab.NETHER_BRICK, 6),
                "PPP",
                "   ",
                "   "
        )).setIngredient("P", Item.get(Item.NETHER_BRICK_BLOCK, 0, 1)));
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.QUARTZ_BLOCK, BlockQuartz.QUARTZ_NORMAL, 1),
                "NN ",
                "NN ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.QUARTZ_BLOCK, BlockQuartz.QUARTZ_PILLAR, 2),
                "N  ",
                "N  ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.QUARTZ_BLOCK, BlockQuartz.QUARTZ_CHISELED, 1),
                "   ",
                " N ",
                " N "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SANDSTONE, BlockSandstone.NORMAL, 1),
                "SS ",
                "SS ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SANDSTONE, BlockSandstone.SMOOTH, 2),
                "S  ",
                "S  ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.SANDSTONE, BlockSandstone.CHISELED, 1),
                "   ",
                " N ",
                " N "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE_BRICK, BlockBricksStone.NORMAL, 1),
                "   ",
                "SS ",
                "SS "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE_BRICK, BlockBricksStone.MOSSY, 1),
                "   ",
                "SL ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE_BRICK, BlockBricksStone.CHISELED, 1),
                "   ",
                " S ",
                " S "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE, BlockStone.GRANITE, 1),
                "   ",
                "DN ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE, BlockStone.POLISHED_GRANITE, 4),
                "   ",
                "GG ",
                "GG "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE, BlockStone.DIORITE, 2),
                "   ",
                "CN ",
                "NC "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE, BlockStone.POLISHED_DIORITE, 4),
                "   ",
                "DD ",
                "DD "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE, BlockStone.ANDESITE, 2),
                "   ",
                "DC ",
                "   "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.STONE, BlockStone.POLISHED_ANDESITE, 4),
                "   ",
                "AA ",
                "AA "
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.GLASS_BOTTLE, 0, 3),
                "I I",
                " I ",
                "   "
    ...
    protected void registerFood() {
        ...
        this.registerRecipe((new BigShapedRecipe(
                Item.get(Item.GOLDEN_APPLE, 1, 1),
                "XXX",
                "XYX",
                "XXX"
